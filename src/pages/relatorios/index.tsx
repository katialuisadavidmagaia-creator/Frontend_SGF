...
function ModalGerarRelatorio({
  ...
  function atualizarCampo(
    campo: keyof GerarRelatorioPayload,
    valor: string
  ) {
    setForm((anterior) => ({
      ...anterior,
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">
                Configure os dados do relatório.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <select
                ...
                disabled={gerando}
                className="w-full appearance-none rounded-xl border border-slate-300 bg-white py-3 pl-10 pr-4 text-sm outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 disabled:bg-slate-50"
              >
                {TIPOS.map((tipo) => (
                  <option
                    key={tipo}
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  disabled={gerando}
                  className="w-full rounded-xl border border-slate-300 px-4 py-3 text-sm outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 disabled:bg-slate-50"
                />
              </div>
...
export default function Relatorios() {
  ...
  const [form, setForm] =
    useState<GerarRelatorioPayload>({
      titulo: '',
      tipo: 'FUNCIONARIOS',
      departamentoId: '',
      dataInicio: '',
  ...
  async function handleEliminar(
    ...
    try {
      await relatoriosService.eliminar(
        String(relatorio.id)
      );

      toast.sucesso(
        'Relatório eliminado com sucesso.'
      );
  ...
  const relatoriosFuncionarios =
    relatorios.filter(
      (r) => r.tipo === 'FUNCIONARIOS'
    ).length;

  const relatoriosProjetos =
    relatorios.filter(
      (r) => r.tipo === 'PROJETOS'
    ).length;
  ...
  return (
    <div className="space-y-6 p-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              {isAdmin
                ? 'Geração, gestão e exportação dos relatórios da organização.'
                : isRH
                ? 'Geração e acompanhamento dos relatórios de recursos humanos.'
                : 'Consulta dos relatórios disponíveis.'}
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-start gap-3 rounded-2xl border border-blue-100 bg-blue-50 p-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-blue-700">
              Pode consultar os relatórios aos quais
              tem acesso.
            </p>
          </div>
        </div>
      ...
      <DataTable<Relatorio>
        ...
        subtitle={
          isAdmin
            ? 'Administre, gere e exporte os relatórios da organização.'
            : isRH
            ? 'Gere e exporte relatórios de recursos humanos.'
            : 'Consulte e exporte os relatórios aos quais tem acesso.'
        }
        data={relatorios}
        loading={carregando}
        searchKeys={[
