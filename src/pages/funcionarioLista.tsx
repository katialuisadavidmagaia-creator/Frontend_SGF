...
export default function ListarFuncionario() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(([jsonFuncionarios, jsonDepartamentos]) => {
        ...
        // Trata a resposta dos Funcionários
        ...
        // Trata a resposta dos Departamentos
  ...
  // Configuração dinâmica dos filtros usando useMemo
  ...
  const actions: Action<Funcionario>[] = [
    ...
    },
    {
      ...
      label: 'Eliminar',
      className: 'danger',
      onClick: (row:Funcionario) => openDeleteDialog(row),
    },
  ];
