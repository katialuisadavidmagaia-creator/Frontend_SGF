  ...
  const filtered = useMemo(() => {
    return data.filter((row) => {
      ...
      for (const filter of filters) {
        const selectedValue =
          filterValues[String(filter.key)];
